...
HOEtaEnergy = TH2F("HOSimHit EtaEnergy", 'SimHits 100GeV/c Neutrinos; SimHit Eta ; Total SimHit Energy (GeV) ; Counts', 31, -15.5,15.5, 20, 0., 0.02)
HOTransEnergy = TH2F("HOSimHit TransEnergy", 'SimHits 100GeV/c Neutrinos; SimHit Eta ; Total SimHit TransEnergy (GeV) ; Counts', 31, -15.5,15.5, 20, 0., 0.02)

HORecoEtaEnergy = TH2F("HOReco EtaEnergy", 'SimHits 100GeV/c Neutrinos; SimHit Eta ; Total RecoHit Energy (GeV) ; Counts', 31, -15.5,15.5, 20, -1.0 , 5.0)
HORecoTransEnergy = TH2F("HOReco TransEnergy", 'SimHits 100GeV/c Neutrinos; SimHit Eta ; Total RecoHit TransEnergy (GeV) ; Counts', 31, -15.5,15.5, 20, -1.0 , 5.0)


HOSimDigi = TH2F("HO SimDigi", 'SimHits 100GeV/c Neutrinos; Time Slice ; SimDigi Charge (fC) ; Counts', 12, -1.0 , 11.0 , 100 , 0.0, 100.0)
HOSimDigiEta = TH2F("HO SimDigi Eta", 'SimHits 100GeV/c Neutrinos; Eta ; SimDigi Charge (fC) ; Counts', 31, -15.5 , 15.5 , 100 , 0.0, 100.0)
HOSimDigiEta2 = TH2F("HO SimDigi Eta", 'SimHits 100GeV/c Neutrinos; Eta ; SimDigi Charge (fC) ; Counts',31, -15.5 , 15.5 , 100 , 0.0, 100.0)
